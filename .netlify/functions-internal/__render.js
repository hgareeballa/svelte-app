...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "apple-logo.png", "size": 4873, "type": "image/png" }, { "file": "backIcon.svg", "size": 481, "type": "image/svg+xml" }, { "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "homeIcon.svg", "size": 706, "type": "image/svg+xml" }],
  ...
  routes: [
    ...
    },
    {
      ...
      a: ["src/routes/__layout.svelte", "src/routes/[searched]/__layout.svelte", "src/routes/[searched]/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
...
var module_lookup = {
  ...
  "src/routes/[searched]/__layout.svelte": () => Promise.resolve().then(function() {
    return __layout;
  }),
...
var logo = "/_app/assets/apple-logo-a493ce07.png";
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"bg-black w-full p-2 px-10 md:px-20 lg:px-52"}"><img${add_attribute("src", logo, 0)} alt="${"logo"}" class="${"h-6"}"></div>`;
});
var _layout$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Header, "Header").$$render($$result, {}, {}, {})}
<div class="${"w-full min-h-screen bg-gradient-to-r from-yellow-600 via-pink-500 to-purple-500 px-10 md:px-20 lg:px-52 py-20"}">${slots.default ? slots.default({}) : ``}</div>`;
});
...
var back = "/_app/assets/backIcon-5f04394b.svg";
